...
cp -p ${VAGRANT_ROOT}/dotfiles/example.bash_aliases /home/vagrant/.bash_aliases

# Add '.bash_profile' to the $HOME directory.
cp -p ${VAGRANT_ROOT}/dotfiles/example.bash_profile /home/vagrant/.bash_profile
# Include the scripts directory in the $PATH.
sed -i 's,VAGRANT_ROOT,'"${VAGRANT_ROOT}"',' /home/vagrant/.bash_profile
